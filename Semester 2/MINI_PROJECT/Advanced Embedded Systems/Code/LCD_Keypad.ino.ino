...
byte pin_rows[row] = {9, 8, 7, 6};      // connect to the row pinouts of the keypad
byte pin_column[col] = {5, 4, 3, 2}; // connect to the column pinouts of the keypad
